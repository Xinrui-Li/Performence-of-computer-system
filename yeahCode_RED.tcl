...
# 文件名保持与算法一致（yeah.nam、yeahTrace.tr）
...
# --- 4. 随机化 TCP Yeah 参数（source1）---
set source1 [new Agent/TCP/Linux]
$ns at 0.0 "$source1 select_ca yeah"  ;# 选择 Yeah 拥塞控制算法
$source1 set class_ 2
$source1 set ttl_ 64
$source1 set windowSize_ 8  ;# Yeah 算法特有参数，保持默认
$source1 set window_ [expr {500 + ($seed % 500)}]  ;# 初始窗口随机
$source1 set packet_size_ 1000
$source1 set rto_ [expr {100 + ($seed % 200)}]  ;# RTO 随机
...
# --- 5. 随机化 TCP Yeah 参数（source2，种子偏移）---
